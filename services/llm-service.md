...
id: llm-service
title: LLM Service
description: "Language model service providing SEO analysis and content planning capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for SEO analysis and content planning. Used by all skills in this skrpt.
